...
const analysisData = {
  ...
  situation: {
    ...
    keyMetrics: [
      ...
      { label: "Brent Crude Peak",     value: "Unverified — awaiting consensus data",       color: "#f59e0b" },
...
const strategicVerdict = {
  ...
  timingDetail: "No new political signals, price confirmations, or de-escalation/escalation triggers have emerged in the last 24 hours. The three critical gating signals — Trump's press statement on war trajectory, Congressional debate on the $200B war funding request, and Brent crude directional movement — remain unresolved. Both independent price checks failed to return consensus live market data for 2026-03-30, preventing any price-driven probability revision. The information environment is unchanged; all five scenario probabilities hold at prior levels. Maintain current strategic positioning until at least one gating signal resolves or verified price data becomes available for cross-referencing.",
  immediateWatchpoints: [
    {
      signal: "Trump press statement on Iran war trajectory",
      timing: "24–48h (carry-forward from prior cycle, now overdue)",
      implication: "Ceasefire signal → oil drops $15–20, risk-on rotation, Negotiated Ceasefire probability surges to ~35%; Escalation signal → oil up $10+, immediate risk-off, Regional Conflagration probability rises to ~25%. Continued absence of statement itself becomes a compounding signal of internal policy indecision, marginally reinforcing Prolonged Stalemate.",
      urgency: "Critical",
    },
    {
      signal: "Congress debate and vote on $200B supplemental war funding request",
      timing: "48–96h (expected committee markup this week)",
      implication: "Passage signals political commitment to extended campaign, reinforcing Stalemate (+3–5%). Rejection or significant trimming raises Negotiated Ceasefire probability sharply. Partisan fracture could signal domestic political constraints forcing de-escalation timeline.",
      urgency: "Critical",
    },
    {
      signal: "Brent crude directional breakout confirmation",
      timing: "24–48h (pending verified market data)",
      implication: "Sustained move above $140/bbl confirms market pricing of escalation / supply disruption, favoring Regional Conflagration. Decline below $125/bbl signals market expectation of diplomatic progress, favoring Negotiated Ceasefire. Range-bound trading confirms Stalemate consensus.",
      urgency: "High",
    },
    {
      signal: "IAEA reporting / intelligence leaks on Iranian enrichment activity",
      timing: "Ongoing monitoring",
      implication: "Any indication of enrichment to >60% or weaponization steps would sharply elevate Nuclear Breakout from 5% toward 10–15%, triggering immediate ESCALATE CAUTION stance shift.",
      urgency: "High",
    },
    {
      signal: "Hezbollah / Houthi operational tempo changes",
      timing: "Ongoing monitoring",
      implication: "Significant uptick in proxy strikes on US assets or Gulf shipping lanes raises Regional Conflagration probability. Quieting of proxy activity could indicate back-channel de-escalation, favoring Negotiated Ceasefire.",
      urgency: "Medium",
    },
  ],
  marketPositioning: [
    {
      ...
      stance: "HOLD",
      color: "#f59e0b",
      rationale: "No verified price data available to confirm directional move. Prior elevated levels assumed to persist given unresolved conflict. Hold existing energy longs; do not add until price confirmation.",
    },
    {
      asset: "US Treasuries (10Y)",
      stance: "HOLD",
      color: "#f59e0b",
      rationale: "Safe-haven bid likely intact given unresolved war scenario. No new fiscal signals from Congress yet. Hold duration exposure as portfolio hedge.",
    },
    {
      asset: "Gold",
      stance: "HOLD",
      color: "#f59e0b",
      rationale: "War premium and inflation hedge remain supported. No de-escalation trigger to justify reduction. Hold current allocation.",
    },
    {
      asset: "USD (DXY)",
      stance: "HOLD",
      color: "#f59e0b",
      rationale: "Dollar likely supported by safe-haven flows but pressured by massive fiscal expansion for war funding. Crosscurrents justify neutral hold.",
    },
    {
      asset: "US Equities (S&P 500)",
      stance: "CAUTIOUS",
      color: "#f59e0b",
      rationale: "Stalemate scenario implies continued elevated uncertainty and energy costs pressuring margins. Maintain underweight vs. benchmark. No catalyst for re-risking yet.",
    },
    {
      asset: "Defense Sector (e.g., LMT, RTX, NOC)",
      stance: "HOLD",
      color: "#10b981",
      rationale: "Pending $200B supplemental funding vote is a direct catalyst. Hold existing overweight; consider adding on funding passage confirmation.",
    },
    {
      asset: "Gulf State Equities / EM MENA",
      stance: "AVOID",
      color: "#ef4444",
      rationale: "Regional Conflagration tail risk at 15% makes direct MENA exposure unattractive on risk-adjusted basis. Avoid until de-escalation signals emerge.",
    },
  ],
  probabilityUpdate: "Stalemate 35% / Ceasefire 25% / Regime Collapse 20% / Conflagration 15% / Nuclear Breakout 5% — No changes. Next trigger: Resolution of any one of three gating signals (Trump statement, Congressional vote, Brent crude breakout).",
  conviction: "Medium",
  nextReview: "2026-04-01 or upon emergence of any gating signal, whichever comes first",
}
