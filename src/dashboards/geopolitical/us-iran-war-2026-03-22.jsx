...
const strategicVerdict = {
  ...
  timingDetail: "No new political signals, price confirmations, or de-escalation/escalation triggers have emerged in the last 24 hours. The three critical watchpoints identified previously — Trump's press statement on war trajectory, Congressional debate on the $200B war funding request, and Brent crude directional movement — remain unresolved. The information environment is stable; all scenario probabilities hold at prior levels. Maintain current strategic positioning until at least one of the three gating signals resolves.",
  immediateWatchpoints: [
    {
      signal: "Trump press statement on Iran war trajectory",
      timing: "24–48h (carry-forward, now imminent)",
      implication: "Ceasefire signal → oil drops $15–20, risk-on rotation; Escalation signal → oil up $10+, immediate risk-off. Absence of statement itself becomes a signal of internal policy indecision, marginally favoring Stalemate.",
      urgency: "Critical",
    },
    {
      signal: "Congress debate on $200B war funding request",
      timing: "48–72h (carry-forward)",
      implication: "Approval signals sustained US commitment, entrenching Prolonged Stalemate; Rejection or significant opposition could accelerate Negotiated Ceasefire probability by 5–10 points.",
      urgency: "High",
    },
    {
      signal: "Brent crude oil price movement",
      timing: "Continuous — next 24–48h directional break key",
      implication: "Sustained move above $135/bbl suggests market pricing in Regional Conflagration; drift below $120/bbl suggests market pricing in ceasefire or stalemate containment.",
      urgency: "High",
    },
    {
      signal: "IAEA or intelligence community reporting on Iranian enrichment activity",
      timing: "Ongoing — any leak or official statement",
      implication: "Evidence of rapid enrichment to >60% or weaponization steps would sharply increase Nuclear Breakout probability from current 5% floor.",
      urgency: "Medium",
    },
  ],
  marketPositioning: [
    {
      ...
      stance: "HOLD",
      color: "#f59e0b",
      rationale: "Elevated war premium persists but no new escalation signal to justify adding. Hold current energy longs; do not chase further until directional clarity from Trump statement or Congressional vote.",
    },
    {
      asset: "Gold",
      stance: "HOLD",
      color: "#f59e0b",
      rationale: "Safe-haven bid remains well-supported by war uncertainty. No reason to reduce; no fresh catalyst to add aggressively.",
    },
    {
      asset: "US Treasuries (10Y)",
      stance: "CAUTIOUS",
      color: "#f59e0b",
      rationale: "Flight-to-safety demand vs. inflationary pressure from energy costs creates cross-currents. The $200B funding request, if approved, expands deficit and may pressure long end. Wait for Congressional signal.",
    },
    {
      asset: "US Equities (S&P 500)",
      stance: "REDUCE RISK",
      color: "#ef4444",
      rationale: "Downside tail risk remains elevated with 15% Regional Conflagration and 5% Nuclear Breakout. Defense sector outperformance likely continues but broad index vulnerable to any escalation shock.",
    },
    {
      asset: "USD/IRR (proxy: USD strength)",
      stance: "HOLD",
      color: "#f59e0b",
      rationale: "Dollar supported by safe-haven flows and energy exporter dynamics. No change warranted absent ceasefire signal.",
    },
  ],
  probabilityUpdate: "Prolonged Stalemate 35% / Negotiated Ceasefire 25% / Regime Collapse 20% / Regional Conflagration 15% / Nuclear Breakout 5% — all unchanged. Next trigger: Trump war trajectory statement (24–48h) or Congressional funding vote (48–72h).",
  conviction: "Medium",
  nextReview: "2026-04-01 or upon any of the three gating signals resolving, whichever comes first",
}
