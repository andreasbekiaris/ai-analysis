...
const strategicVerdict = {
  ...
  immediateWatchpoints: [
    ...
    },
    {
      ...
      timing: "48–72h",
      implication: "Approval signals continued US commitment, potentially prolonging stalemate or increasing escalation risk. Rejection could signal de-escalation or a shift in US strategy.",
      urgency: "High",
    },
    {
      signal: "Brent crude oil price movement",
      timing: "Ongoing (24h)",
      implication: "Sustained upward pressure (> $10/barrel increase) suggests rising regional conflagration risk. Significant drops suggest de-escalation or ceasefire prospects.",
      urgency: "High",
    },
  ],
  marketPositioning: [
    {
      ...
      stance: "HOLD",
      color: "#f59e0b",
      rationale: "Volatile due to geopolitical risk. Awaiting clarity on escalation/de-escalation signals.",
    },
    {
      asset: "US Equities",
      stance: "HOLD",
      color: "#f59e0b",
      rationale: "Uncertainty surrounding war funding and potential escalation/de-escalation. Monitor Trump's statement for risk-on/risk-off cues.",
    },
    {
      asset: "Gold",
      stance: "HOLD",
      color: "#f59e0b",
      rationale: "Safe-haven demand is currently balanced by potential risk-on sentiment if de-escalation occurs. Awaiting clearer directional signals.",
    },
  ],
