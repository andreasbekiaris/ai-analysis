  ...
  immediateWatchpoints: [
    {
      ...
      timing: "24–48h",
      implication: "Ceasefire signal → oil drops $15–20, risk-on; Escalation signal → oil up $10+, risk-off",
      urgency: "High",
    },
    {
      signal: "Congress debate on $200B war funding request",
      timing: "48–72h",
      implication: "Approval signals continued US commitment, potentially prolonging stalemate; Rejection could force re-evaluation of US strategy.",
      urgency: "High",
    },
    {
      signal: "Brent crude oil price movement",
      timing: "Ongoing",
      implication: "Sustained drops below $80 suggest de-escalation; sustained spikes above $95 signal rising regional conflagration risk.",
      urgency: "High",
    },
  ],
  marketPositioning: [
    {
      ...
      stance: "HOLD",
      color: "#f59e0b",
      rationale: "Volatile due to geopolitical risk; awaiting clearer signals on war trajectory.",
    },
    {
      asset: "US Equities",
      stance: "HOLD",
      color: "#f59e0b",
      rationale: "Uncertainty over war funding and potential escalation/de-escalation creates mixed signals.",
    },
    {
      asset: "Gold",
      stance: "HOLD",
      color: "#f59e0b",
      rationale: "Safe-haven demand is present but tempered by lack of immediate major escalation.",
    },
  ],
  probabilityUpdate: "Prolonged Stalemate 35% / Negotiated Ceasefire 25% / Regime Collapse 20% / Regional Conflagration 15% / Nuclear Breakout 5% — Next trigger: Trump statement, Congressional funding debate, or Brent crude movement.",
  conviction: "Medium",
